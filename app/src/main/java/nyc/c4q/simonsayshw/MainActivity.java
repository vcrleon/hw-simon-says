...
//    private ArrayList<Button> simonSequence = new ArrayList<>(); //data structure to store the sequence of the random colors that the shuffle method generates
//    private ArrayList<Button> colorsClicked = new ArrayList<>(); //data structure to store the sequence of the colors that the player clicks
...
//    public void simonSequenceRuns(Button btn){
//        simonSequence.add(btn);
//        int flashingColor = getResources().getColor(R.color.black);
//
//        switch(btn.getId()) {
//            case  R.id.green_button:
//                flashingColor = getResources().getColor(R.color.light_green);
//                break;
//            case R.id.yellow_button:
//                flashingColor = getResources().getColor(R.color.light_yellow);
//                break;
//            case R.id.blue_button:
//                flashingColor = getResources().getColor(R.color.light_blue);
//                break;
//            case R.id.red_button:
//                flashingColor = getResources().getColor(R.color.light_red);
//                break;
//            default:
//                break;
//        }
//        btn.setBackgroundColor(flashingColor);
//    }
//
//    public void normalColors(Button btn){
...
//        switch(btn.getId()) {
//            case  R.id.green_button:
//                normalColor = getResources().getColor(R.color.green);
//                break;
//            case R.id.yellow_button:
...
//                break;
//            case R.id.red_button:
//                normalColor = getResources().getColor(R.color.red);
//                break;
//            default:
//                break;
//        }
